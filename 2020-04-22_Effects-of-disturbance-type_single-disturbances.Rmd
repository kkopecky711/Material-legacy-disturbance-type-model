...
plot(disturb_set, C_D.phys.eq_cover.single.coral_state, col = "black", lwd = 2, lty = 'solid', type = 'l', xlab = "Severity of disturbance", ylab = "Equilibrium cover", xlim = c(0, 1), ylim = c(0, 1.1), main = "Live coral and total macroalgae by disturbance type, coral state")
...
plot(disturb_set.t_eq,system_equilibration.bio, col = "black", lwd = 2, lty = 'dashed', type = 'l', xlab = "Severity of disturbance", ylab = "Time to equilibrium (months)", ylim = c(0,4500))
